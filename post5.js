...
;(function () {
...
})()(
  {
      ...
      function (require, module, exports) {
        ...
        class CelShade extends merge_pass_1.WrappedExpr {
          constructor(mult, bump, center, edge) {
            ...
            const smooth = merge_pass_1.cfloat(
              merge_pass_1.tag`(smoothstep(-${edgeFloat} + ${centerFloat}, ${edgeFloat} + ${centerFloat}, ${merge_pass_1.rgb2hsv(
                merge_pass_1.fcolor()
              )}.z) * ${multFloat} + ${bumpFloat})`
            )
            const expr = merge_pass_1.hsv2rgb(
              merge_pass_1.changecomp(
                merge_pass_1.rgb2hsv(merge_pass_1.fcolor()),
                smooth,
                'z'
              )
            )
        ...
        function celshade(
          mult = merge_pass_1.mut(0.8),
          bump = merge_pass_1.mut(0.3),
          center = merge_pass_1.mut(0.3),
          edge = merge_pass_1.mut(0.03)
        ) {
          return new CelShade(
            merge_pass_1.wrapInValue(mult),
            merge_pass_1.wrapInValue(bump),
            merge_pass_1.wrapInValue(center),
            merge_pass_1.wrapInValue(edge)
          )
        }
        exports.celshade = celshade
      },
      ...
      function (require, module, exports) {
        ...
        class OldFilm extends merge_pass_1.WrappedExpr {
          constructor(speckIntensity, lineIntensity, grainIntensity) {
            ...
            const rate = 10
            const triangles = merge_pass_1.op(
              merge_pass_1.op(
                merge_pass_1.op(
                  merge_pass_1.a1(
                    'abs',
                      ...
                      merge_pass_1.op(
                        ...
                        merge_pass_1.a1(
                          ...
                          merge_pass_1.op(
                            rate,
                            '*',
                            merge_pass_1.getcomp(merge_pass_1.pos(), 'x')
                          )
                        )
                      ),
                      '-',
            ...
            const stepping = merge_pass_1.a2(
              'step',
              merge_pass_1.op(1, '-', merge_pass_1.op(1, '/', rate * 12)),
              merge_pass_1.a2(
                'mod',
                merge_pass_1.op(
                  merge_pass_1.getcomp(merge_pass_1.pos(), 'x'),
        ...
        function oldfilm(
          ...
          lineIntensity = merge_pass_1.mut(0.12),
    ...
    9: [
      ...
      { './index': 4, '@bandaloo/merge-pass': 62 },
    ],
    10: [
      function (require, module, exports) {
        'use strict'
        ...
        class Vignette extends merge_pass_1.EffectLoop {
          constructor(blurScalar, brightnessScalar, brightnessExponent) {
            ...
            const brightnessExponentFloat =
              merge_pass_1.float(brightnessExponent)
...
uniform mediump vec2 uResolution;\n`
      ...
      { './exprs/expr': 25, './settings': 64, './webglprogramloop': 66 },
    ],
    12: [
      function (require, module, exports) {
        'use strict'
    ...
    15: [
      ...
      { '../mergepass': 63, './blurexpr': 16, './expr': 25, './vecexprs': 59 },
    ],
    16: [
      function (require, module, exports) {
        'use strict'
    ...
    17: [
      ...
      { '../glslfunctions': 61, './expr': 25, './fragcolorexpr': 26 },
    ],
    18: [
      function (require, module, exports) {
        'use strict'
  ...
  return col;
    ...
    21: [
      ...
      { './channelsampleexpr': 19, './expr': 25, './vecexprs': 59 },
    ],
    22: [
      function (require, module, exports) {
        'use strict'
    ...
    25: [
      function (require, module, exports) {
        ...
        exports.tag =
          ...
          exports.BasicVec2 =
          exports.BasicVec =
          exports.PrimitiveVec4 =
          exports.PrimitiveVec3 =
          exports.PrimitiveVec2 =
          exports.PrimitiveVec =
          exports.PrimitiveFloat =
          exports.Primitive =
          exports.mut =
          exports.Mutable =
          exports.cvec4 =
        ...
        class Expr {
          ...
          parse(buildInfo) {
            ...
            this.sourceCode +=
              this.sourceLists.sections[this.sourceLists.sections.length - 1]
      ...
      { '../mergepass': 63, '../utils': 65, '../webglprogramloop': 66 },
    ],
    26: [
      function (require, module, exports) {
        'use strict'
    ...
    30: [
      function (require, module, exports) {
        ...
        exports.get4comp =
          ...
          exports.get2comp =
          exports.getcomp =
          exports.Get4CompExpr =
          exports.Get3CompExpr =
          exports.Get2CompExpr =
          exports.GetCompExpr =
          exports.checkLegalComponents =
          exports.typeStringToLength =
            void 0
        const expr_1 = require('./expr')
    ...
    44: [
      ...
      { '../glslfunctions': 61, './expr': 25, './opexpr': 43 },
    ],
    45: [
      function (require, module, exports) {
        'use strict'
    ...
    46: [
      ...
      { '../glslfunctions': 61, './expr': 25, './normfragcoordexpr': 41 },
    ],
    47: [
      function (require, module, exports) {
        'use strict'
  ...
  return texture2D(sampler, uv);
    ...
    62: [
      ...
      },
      {
        ...
        './exprs/blur2dloop': 15,
        './exprs/blurexpr': 16,
        './exprs/brightnessexpr': 17,
        './exprs/changecompexpr': 18,
        './exprs/channelsampleexpr': 19,
        './exprs/contrastexpr': 20,
        './exprs/depthtoocclusionexpr': 21,
        './exprs/dofloop': 22,
        './exprs/edgecolorexpr': 23,
        './exprs/edgeexpr': 24,
        './exprs/expr': 25,
        './exprs/fragcolorexpr': 26,
        './exprs/fragcoordexpr': 27,
        './exprs/fxaaexpr': 28,
        './exprs/getcompexpr': 30,
        './exprs/godraysexpr': 31,
        './exprs/grainexpr': 32,
        './exprs/hsvtorgbexpr': 33,
        './exprs/invertexpr': 34,
        './exprs/lenexpr': 35,
        './exprs/monochromeexpr': 36,
        './exprs/motionblurloop': 37,
        './exprs/mouseexpr': 38,
        './exprs/normcenterfragcoordexpr': 39,
        './exprs/normexpr': 40,
        './exprs/normfragcoordexpr': 41,
        './exprs/normmouseexpr': 42,
        './exprs/opexpr': 43,
        './exprs/perlinexpr': 44,
        './exprs/powerblur': 45,
        './exprs/randomexpr': 46,
        './exprs/regiondecorator': 47,
        './exprs/resolutionexpr': 48,
        './exprs/rgbtohsvexpr': 49,
        './exprs/rotateexpr': 50,
        './exprs/scenesampleexpr': 51,
        './exprs/simplexexpr': 53,
        './exprs/sobelexpr': 54,
        './exprs/ternaryexpr': 55,
        './exprs/timeexpr': 56,
        './exprs/translateexpr': 57,
        './exprs/truedepthexpr': 58,
        './exprs/vecexprs': 59,
        './exprtypes': 60,
        './glslfunctions': 61,
        './mergepass': 63,
  ...
  gl_Position = vec4(aPosition, 0.0, 1.0);
    ...
    65: [
      function (require, module, exports) {
        'use strict'
        Object.defineProperty(exports, '__esModule', { value: true })
        exports.brandWithRegion =
          exports.brandWithChannel =
          exports.captureAndAppend =
            void 0
        const glslfunctions_1 = require('./glslfunctions')
        /** @ignore */
    ...
    66: [
      function (require, module, exports) {
        'use strict'
        Object.defineProperty(exports, '__esModule', { value: true })
        exports.WebGLProgramLoop =
          exports.WebGLProgramLeaf =
          exports.updateNeeds =
            void 0
        const settings_1 = require('./settings')
        // update me on change to needs
